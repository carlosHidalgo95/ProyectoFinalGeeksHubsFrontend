...
const BookingContainer = () => {
  ...
  const [postre, setPostre] = useState({ dish_name: "" });
  ...
  const handleButtonClick = () => {
    let valid = true;
    if (!entrante || !primero || !segundo || !postre) {
      setError("Debes seleccionar los 4 platos a reservar")
      valid = false;
    }
    if (!date || !time) {
